    ...
    <div>
      ...
      <div className={`container mt-8 mx-auto px-4 py-8 ${textColor}`}>
        ...
        <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
          ...
          <li>
            <div className={`timeline-middle ${textHighlight}`}>
              <CircleCheckBig className="w-8 h-8 p-1" />
            </div>
            <div className="timeline-start mb-10 md:text-end">
              <time className="font-mono italic">March 15, 2002</time>
              <div className={`text-lg font-black font-mono ${textHighlight}`}>Foundation of Celestial Innovations</div>
          ...
          <li>
            ...
            <div className="timeline-end md:mb-10">
              ...
              <div className={`text-lg font-black font-mono ${textHighlight}`}>Mercury Mk-I: The First Suborbital Test Flight</div>
          ...
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end">
              ...
              <div className={`text-lg font-black font-mono ${textHighlight}`}>Orion Launch Vehicle: Reaching Orbit</div>
          ...
          <li>
            ...
            <div className="timeline-end md:mb-10">
              ...
              <div className={`text-lg font-black font-mono ${textHighlight}`}>Phoenix Booster: The Reusability Breakthrough</div>
          ...
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end">
              ...
              <div className={`text-lg font-black font-mono ${textHighlight}`}>First Commercial Satellite Launch</div>
          ...
          <li>
            ...
            <div className="timeline-end md:mb-10">
              ...
              <div className={`text-lg font-black font-mono ${textHighlight}`}>Pegasus-1: The Inaugural Manned Mission</div>
          ...
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end">
              ...
              <div className={`text-lg font-black font-mono ${textHighlight}`}>Artemis Pathfinder: Pioneering Mars Exploration</div>
          ...
          <li>
            ...
            <div className="timeline-end md:mb-10">
              ...
              <div className={`text-lg font-black font-mono ${textHighlight}`}>Celestia Orbital Habitat: A New Era in Space Living</div>
          ...
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end">
              ...
              <div className={`text-lg font-black font-mono ${textHighlight}`}>Odyssey: The Reusable Interplanetary Transport System</div>
          ...
          <li>
            ...
            <div className="timeline-end md:mb-10">
              ...
              <div className={`text-lg font-black font-mono ${textHighlight}`}>Nova Station: The Orbital Commercial Hub</div>
          ...
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end">
              ...
              <div className={`text-lg font-black font-mono ${textHighlight}`}>Lunar Gateway 2.0: Next-Generation Lunar Base</div>
          ...
          <li>
            ...
            <div className="timeline-end md:mb-10">
              ...
              <div className={`text-lg font-black font-mono ${textHighlight}`}>Mars Colony Initiative: Red Frontier</div>
