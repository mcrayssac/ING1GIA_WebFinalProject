...
import { ChartNoAxesCombined, LibraryBig, Heart, TrendingUp, View, ClipboardCheck, Rocket, Satellite, Antenna, CircleCheckBig, CircleEllipsis } from "lucide-react";
        ...
        <div className="flex items-center justify-center">
          <div className="stats stats-vertical lg:stats-horizontal shadow-xl m-8 mx-auto bg-primary">
            ...
            <div className="stat">
              ...
              <div className="stat-title text-primary-content">Total likes</div>
              <div className={`stat-value text-accent-foreground`}>25.6K</div>
            ...
            <div className="stat">
              ...
              <div className="stat-title text-primary-content">Page views</div>
              <div className={`stat-value text-accent-foreground`}>1.2M</div>
              <div className={`stat-desc text-primary-content`}>
                <div className='flex items-center space-x-2'>
                  <TrendingUp className='w-4 h-4' />
            ...
            <div className="stat">
              ...
              <div className="stat-title text-primary-content">Mission success rate</div>
              <div className={`stat-value text-accent-foreground`}>98%</div>
              <div className={`stat-desc text-primary-content`}>
            ...
            <div className="stat">
              ...
              <div className="stat-title text-primary-content">Total launches</div>
              <div className={`stat-value text-accent-foreground`}>448</div>
              <div className={`stat-desc text-primary-content`}>405 Successful missions to date</div>
            </div>
            ...
            <div className="stat">
              ...
              <div className="stat-title text-primary-content">Satellites deployed</div>
              <div className={`stat-value text-accent-foreground`}>2.3K</div>
              <div className={`stat-desc text-primary-content`}>
                <div className='flex items-center space-x-2'>
        ...
        <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
          ...
          <li>
            <div className={`timeline-middle text-secondary`}>
              <CircleCheckBig className="w-8 h-8 p-1" />
            </div>
            <div className="timeline-start mb-10 md:text-end">
              <time className="font-mono italic text-muted-foreground">March 15, 2002</time>
              <div className={`text-lg font-black font-mono text-secondary`}>Foundation of Celestial Innovations</div>
          ...
          <li>
            ...
            <div className="timeline-end md:mb-10">
              <time className="font-mono italic text-muted-foreground">June 27, 2004</time>
              <div className={`text-lg font-black font-mono text-secondary`}>Mercury Mk-I: The First Suborbital Test Flight</div>
          ...
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end">
              <time className="font-mono italic text-muted-foreground">September 12, 2008</time>
              <div className={`text-lg font-black font-mono text-secondary`}>Orion Launch Vehicle: Reaching Orbit</div>
          ...
          <li>
            ...
            <div className="timeline-end md:mb-10">
              <time className="font-mono italic text-muted-foreground">November 3, 2010</time>
              <div className={`text-lg font-black font-mono text-secondary`}>Phoenix Booster: The Reusability Breakthrough</div>
          ...
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end">
              <time className="font-mono italic text-muted-foreground">April 18, 2012</time>
              <div className={`text-lg font-black font-mono text-secondary`}>First Commercial Satellite Launch</div>
          ...
          <li>
            ...
            <div className="timeline-end md:mb-10">
              <time className="font-mono italic text-muted-foreground">July 22, 2015</time>
              <div className={`text-lg font-black font-mono text-secondary`}>Pegasus-1: The Inaugural Manned Mission</div>
          ...
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end">
              <time className="font-mono italic text-muted-foreground">March 3, 2018</time>
              <div className={`text-lg font-black font-mono text-secondary`}>Artemis Pathfinder: Pioneering Mars Exploration</div>
          ...
          <li>
            ...
            <div className="timeline-end md:mb-10">
              <time className="font-mono italic text-muted-foreground">August 14, 2021</time>
              <div className={`text-lg font-black font-mono text-secondary`}>Celestia Orbital Habitat: A New Era in Space Living</div>
          ...
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end">
              <time className="font-mono italic text-muted-foreground">December 2, 2023</time>
              <div className={`text-lg font-black font-mono text-secondary`}>Odyssey: The Reusable Interplanetary Transport System</div>
          ...
          <li>
            <hr />
            <div className={`timeline-middle text-secondary`}>
              <CircleEllipsis className="w-8 h-8 p-1" />
            </div>
            <div className="timeline-end md:mb-10">
              <time className="font-mono italic text-muted-foreground">Scheduled for Q3 2027</time>
              <div className={`text-lg font-black font-mono text-secondary`}>Nova Station: The Orbital Commercial Hub</div>
          ...
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end">
              <time className="font-mono italic text-muted-foreground">Targeted for 2029</time>
              <div className={`text-lg font-black font-mono text-secondary`}>Lunar Gateway 2.0: Next-Generation Lunar Base</div>
          ...
          <li>
            ...
            <div className="timeline-end md:mb-10">
              <time className="font-mono italic text-muted-foreground">Planned for 2035</time>
              <div className={`text-lg font-black font-mono text-secondary`}>Mars Colony Initiative: Red Frontier</div>
